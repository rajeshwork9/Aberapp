                            ...
                            <View style={styles.cardContentInner}>
                                <View style={styles.leftCardCont}>
                                    ...
                                    <View style={styles.leftTextCard}>
                                        <Text style={[styles.textCard, {fontFamily:'Poppins-SemiBold'}]}>VVRAQ0000012</Text>
                                        <Text style={styles.textCard}> <Image style={styles.calenderIcon} source={require('../../assets/images/calendar-icon.png')} />  01 Mar 2025 - 31 May 2025</Text>
                                    </View>
                                </View>
